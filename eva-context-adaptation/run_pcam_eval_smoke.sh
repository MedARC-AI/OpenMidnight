#!/bin/bash
# =============================================================================
# PCam Evaluation Smoke Test - Fair Comparison
# =============================================================================
#
...
PCAM_ROOT=${PCAM_ROOT:-/data/eva-data/patch_camelyon}
CAMELYON_ROOT=${CAMELYON_ROOT:-/data/eva-data/camelyon16}
...
# Output directories
OUTPUT_BASE=${OUTPUT_BASE:-/home/paul/OpenMidnight/outputs/pcam_eval_smoke}
...
EVAL_CONFIG=${EVAL_CONFIG:-/home/paul/OpenMidnight/eval_configs/pcam_embeddings_only.yaml}
...
EVAL_SCRIPT="${SCRIPT_DIR}/pcam_context_eval.py"

echo "=============================================="
echo "PCam Evaluation Smoke Test"
echo "=============================================="
echo "Samples per split: ${N_SAMPLES}"
echo "PCam root:         ${PCAM_ROOT}"
echo "Camelyon root:     ${CAMELYON_ROOT}"
...
if [ "${SKIP_BASELINE}" = "true" ]; then
    ...
    echo "    This uses the exact H5 patches from PCam."
    echo ""
