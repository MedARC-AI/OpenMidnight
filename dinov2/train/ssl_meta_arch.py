...
from dinov2.loss import MCRLoss, DINOLoss, CosinePatchLoss, iBOTPatchLoss, KoLeoLoss
...
class SSLMetaArch(nn.Module):
    def __init__(self, cfg):
        ...
        if self.do_dino:
            ...
            head_normalize = getattr(cfg.dino, "head_normalize", True)
            remove_last_layer = getattr(cfg.dino, "remove_last_layer", True)
        ...
        logger.info(f"Student and Teacher are built: {cfg.student.arch}")
